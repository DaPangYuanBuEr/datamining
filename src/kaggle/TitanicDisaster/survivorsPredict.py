...
data_tet = pd.read_csv("data/test.csv")
...
def simplify_ages(df):
    ...
    group_name = ["Unkown","Baby","Child","Teenger","Student","Young Adult","Adult","Senior"]
...
data_tet = transform_features(data_tet)
...
data_train,data_tet = encode_features(data_train, data_tet)
data_train.head(3)
...
ids = data_tet['PassengerId']
predictions = clf.predict(data_tet.drop('PassengerId', axis=1))
